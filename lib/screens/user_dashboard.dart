...
import 'package:land_registration/screens/editLandDetails.dart';
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(flex: 1, child: Center(child: Text(data[3].toString()))),
              Expanded(
                  flex: 5,
                  child: Center(
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(flex: 2, child: Center(child: Text(data[5].toString()))),
              Expanded(
                  flex: 2,
                  child: Center(
                    child: ElevatedButton(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              return landWid(
                ...
                // This is the new edit functionality
                List<String> allLatiLongi =
                    landInfo[index][4].toString().split('|');
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => EditLandDetails(
                              allLatitude: allLatiLongi[0],
                              allLongitude: allLatiLongi[1],
                              landinfo: landinfo,
                            )));
                ...
                children: [
                  Expanded(
                      child: CustomTextFiled(
                          userInfo[0].toString(), 'Wallet Address')),
                  Expanded(
                      child: CustomTextFiled(userInfo[1].toString(), 'Name')),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  Expanded(
                      child: CustomTextFiled(userInfo[2].toString(), 'Age')),
                  Expanded(
                      child: CustomTextFiled(userInfo[3].toString(), 'City')),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  Expanded(
                      child: CustomTextFiled(userInfo[4].toString(), 'NID')),
                  Expanded(
                      child: CustomTextFiled(userInfo[5].toString(), 'TaxId')),
                ],
              ),
              TextButton(
                onPressed: () {
