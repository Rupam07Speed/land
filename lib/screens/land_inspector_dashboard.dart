        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(flex: 2, child: Center(child: Text(data[3].toString()))),
              Expanded(flex: 2, child: Center(child: Text(data[5].toString()))),
              Expanded(flex: 2, child: Center(child: Text(data[6].toString()))),
              Expanded(
                  flex: 2,
                  child: Center(
                      child: TextButton(
          ...
          return Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                    flex: 2, child: Center(child: Text(data[4].toString()))),
                Expanded(
                    flex: 2, child: Center(child: Text(data[5].toString()))),
                Expanded(
                    flex: 2,
                    child: Center(
                        child: TextButton(
          ...
          return Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                    flex: 6, child: Center(child: Text(data[2].toString()))),
                Expanded(
                    flex: 2,
                    child: Center(
