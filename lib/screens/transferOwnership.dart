...
class _transferOwnershipState extends State<transferOwnership> {
  ...
  generateDocument(villegename, price, sellername, buyername, selleraddress,
      buyeraddress, surveyno, area, date, sellerTaxid, buyerTaxid) async {
    pdf.addPage(pw.Page(
          ...
          return pw.Column(
              ...
              children: [
                ...
                pw.Table(columnWidths: {
                  ...
                  tableRowSizedBox(),
                  tableRow("10)Stamp Duty paid amount:", "BDT. 6000"),
                  tableRowSizedBox(),
                  tableRow("11)Registration Serial No.:", "613"),
                  tableRowSizedBox(),
                  tableRow("12)Registration Fee:", "BDT.5000"),
                  tableRowSizedBox(),
                ]),
                pw.Divider(height: 2),
                pw.Divider(height: 2),
  ...
  Widget sellerProfile(
      sellerOrBuyer, walletAddres, name, age, city, nid, taxid, docu, mail) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextFiled(nid.toString(), 'Nid Number'),
          CustomTextFiled(taxid.toString(), 'Taxid'),
          TextButton(
            onPressed: () {
