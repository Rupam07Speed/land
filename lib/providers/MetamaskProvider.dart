...
class MetaMaskProvider extends ChangeNotifier {
  ...
  final abi = [
    ...
    "function UserMapping(address) public view returns(address id,string name,uint age,string city,string nidNumber,string TaxidNumber,string document,string email,bool isUserVerified)",
    ...
    "function registerUser(string memory _name, uint _age, string memory _city,string memory _anidNumber, string memory _TaxidNumber, string memory _document, string memory _email) public",
    ...
    "function updateLandPrice(uint landId, uint newPrice) public"
  ];
  ...
  Future<void> updateLand({
    ...
    required String allLatiLongi,
    required int propertyPID,
    required String surveyNum,
    required String document,
  }) async {
    try {
      await contract.send('updateLand', [
        landId,
        area,
        address,
        newPrice,
      ...
      print('Error updating land details: $e');
      showToast('Error updating land details.', backgroundColor: Colors.red);
      throw e; // rethrow the error so that you can handle it in your UI if needed
    }
  }
  ...
  registerUser(String name, String age, String city, String nid, String Taxid,
      String document, String email) async {
    await contract.send(
      'registerUser',
      [name, age, city, nid, Taxid, document, email],
    );
  }
