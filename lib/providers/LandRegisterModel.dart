...
class LandRegisterModel extends ChangeNotifier {
  ...
  late ContractFunction _updateLandPrice;
  ...
  Future<void> getDeployedContract() async {
    ...
    _updateLandPrice = _contract.function("updateLandPrice");
  }

  Future<void> updateLandPrice(int landId, BigInt newPrice) async {
    notifyListeners();
    try {
      await _client.sendTransaction(
          ...
          Transaction.callContract(
              contract: _contract,
              function: _updateLandPrice,
              parameters: [BigInt.from(landId), newPrice]),
          chainId: _chainId,
          fetchChainIdFromNetworkId: false);
      print("Land price updated successfully!");
    } catch (error) {
      print("Failed to update land price: $error");
    }
  }
